...
export const scenarioGuides: Record<string, ScenarioGuide> = {
  ...
  "middle-east-escalation": {
    category: "Macro",
    question: "What if conflict in the Middle East widens and disrupts energy and shipping routes?",
    meaning: "Oil, freight, inflation expectations, defense demand, and safe-haven currencies move together while risk appetite weakens.",
    review: "Separate direct defense exposure from the less visible margin and valuation pressure carried through the S&P 500.",
    trigger: "Regional conflict widens",
    transmission: ["Energy and freight costs rise", "Inflation constrains central banks", "Risk premia and defense orders increase"],
    pressure: ["Airlines and transport", "European industrial margins", "Long-duration growth"],
    support: ["Energy producers", "Defense contractors", "USD exposure for a NOK investor"],
    watch: ["Brent crude and tanker rates", "Strait and Suez traffic", "Defense order books", "Credit spreads and USD/NOK"],
    directTickers: ["SXR8", "ITA", "LMT", "SAAB-B"],
    companies: [
      { ticker: "LMT", name: "Lockheed Martin", sensitivity: "High", balanceSheet: "Funded backlog with program concentration", channel: "Missile, air-defense, and replenishment demand" },
      { ticker: "RTX", name: "RTX", sensitivity: "High", balanceSheet: "Aerospace and defense mix", channel: "Air-defense demand offsets commercial aviation pressure" },
      { ticker: "DAL", name: "Delta Air Lines", sensitivity: "High", balanceSheet: "Fuel and travel sensitivity", channel: "Jet fuel, rerouting, and consumer confidence" },
      { ticker: "XOM", name: "Exxon Mobil", sensitivity: "Low", balanceSheet: "Commodity-linked free cash flow", channel: "Higher realized oil and gas prices" },
    ],
  },
  "middle-east-deescalation": {
    category: "Macro",
    question: "What if the United States and regional powers achieve a durable Middle East de-escalation?",
    meaning: "Oil and freight risk premia recede, credit conditions improve, and cyclical assets benefit while defense momentum cools.",
    review: "Test whether the portfolio depends on geopolitical tension, or can benefit from broader earnings and lower inflation risk.",
    trigger: "Durable ceasefire and shipping normalization",
    transmission: ["Energy risk premium falls", "Inflation pressure eases", "Capital rotates toward cyclicals"],
    pressure: ["Pure defense momentum", "High-cost energy supply", "Safe-haven currency trades"],
    support: ["Transport and airlines", "European industrials", "Rate-sensitive quality growth"],
    watch: ["Brent curve", "Suez transit volumes", "Sovereign spreads", "Defense procurement guidance"],
    directTickers: ["SXR8", "ITA", "LMT", "SAAB-B", "MSFT", "GOOGL"],
    companies: [
      { ticker: "DAL", name: "Delta Air Lines", sensitivity: "High", balanceSheet: "Fuel-intensive operations", channel: "Lower fuel and rerouting costs" },
      { ticker: "FDX", name: "FedEx", sensitivity: "Medium", balanceSheet: "Capital-intensive logistics", channel: "Lower fuel costs and normalized routes" },
      { ticker: "LMT", name: "Lockheed Martin", sensitivity: "Medium", balanceSheet: "Long-cycle backlog", channel: "Near-term sentiment may cool before contracted demand" },
      { ticker: "MSFT", name: "Microsoft", sensitivity: "Low", balanceSheet: "Net-cash quality", channel: "Lower risk premia support valuation duration" },
    ],
  },
  "rates-up": {
