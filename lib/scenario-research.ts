...
export const scenarioGuides: Record<string, ScenarioGuide> = {
  ...
  "rates-higher-longer": {
    category: "Rates & credit",
    question: "What if policy rates stay restrictive for another two years?",
    meaning: "Valuation pressure persists and refinancing costs rise gradually as fixed-rate debt matures.",
    review: "Distinguish companies with expensive valuations from companies with near-term funding needs.",
    trigger: "Inflation remains sticky",
    transmission: ["Cuts are delayed", "Debt reprices over time", "Long-duration multiples remain compressed"],
    pressure: ["Leveraged real estate", "Unprofitable growth", "Near-term debt maturities"],
    support: ["Net-cash companies", "Short-duration bonds", "Insurers and cash-rich banks"],
    watch: ["Core services inflation", "Debt maturity schedules", "Real yields", "Interest coverage"],
    directTickers: ["SXR8", "MSFT", "NVDA"], companies: [],
  },
  "oil-below-50": {
    category: "Macro",
    question: "What if oil falls below $50 because global demand weakens?",
    meaning: "Energy earnings and oil-linked currencies weaken while transport costs and inflation ease.",
    review: "Separate the benefit of cheaper energy from the recession signal that may have caused it.",
    trigger: "Demand-driven oil collapse",
    transmission: ["Producer cash flow falls", "NOK weakens", "Inflation and rates ease"],
    pressure: ["Energy producers", "Oil services", "Commodity-linked lenders"],
    support: ["Airlines and logistics", "Energy-intensive manufacturing", "Long-duration government bonds"],
    watch: ["Brent curve", "Global PMIs", "Energy capex", "USD/NOK"],
    directTickers: ["EQNR", "XLE", "SXR8"], companies: [],
  },
  "china-balance-sheet": {
    category: "Macro",
    question: "What if China enters a prolonged balance-sheet recession?",
    meaning: "Private deleveraging suppresses demand even as policy eases, weakening exporters and commodities.",
    review: "Map indirect China exposure through customers, inputs, and European export demand.",
    trigger: "Property losses drive deleveraging",
    transmission: ["Domestic demand weakens", "Commodity imports fall", "Global manufacturing slows"],
    pressure: ["European luxury", "Materials and miners", "Asian exporters"],
    support: ["Domestic defensives", "High-quality sovereign bonds", "Low-China revenue exposure"],
    watch: ["Property sales", "Credit impulse", "Iron ore", "European export orders"],
    directTickers: ["SXR8", "LVMH", "SIE"], companies: [],
  },
  "europe-defense": {
    category: "Macro",
    question: "What if Europe accelerates defense spending for a decade?",
    meaning: "Backlogs, capacity investment, and procurement rise, but execution and valuation risk remain.",
    review: "Test whether defense exposure is diversified across programs, countries, and supply chains.",
    trigger: "Durable procurement commitments",
    transmission: ["Order books expand", "Capacity investment rises", "Industrial supply chains tighten"],
    pressure: ["Civil spending trade-offs", "Fixed-price contracts", "Crowded valuations"],
    support: ["Defense primes", "Ammunition suppliers", "Dual-use industrial technology"],
    watch: ["NATO budgets", "Order intake", "Working capital", "Program margins"],
    directTickers: ["SAAB-B", "RHM", "SAF", "ITA"], companies: [],
  },
  "trade-restrictions": {
    category: "Macro",
    question: "What if tariffs and technology export restrictions intensify?",
    meaning: "Supply chains duplicate, costs rise, and internationally exposed companies face slower growth.",
    review: "Identify revenue concentration, manufacturing dependencies, and substitution options.",
    trigger: "Tariffs and export controls broaden",
    transmission: ["Input costs rise", "Trade volumes fall", "Capital spending relocates"],
    pressure: ["Semiconductors", "Global industrials", "Low-margin importers"],
    support: ["Domestic suppliers", "Defense and cyber security", "Supply-chain software"],
    watch: ["Tariff schedules", "Export licences", "Freight routes", "Gross-margin guidance"],
    directTickers: ["NVDA", "2330", "SXR8", "ITA"], companies: [],
  },
  custom: {
    category: "Currency",
